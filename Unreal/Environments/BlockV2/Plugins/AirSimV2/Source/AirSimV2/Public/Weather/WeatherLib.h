...
class AIRSIM_API UWeatherLib : public UBlueprintFunctionLibrary
{
    ...
    {
        return FSoftClassPath(TEXT("AActor'/AirSimV2/Weather/UI/MenuActor.MenuActor_C'"));
    }

    static const FSoftClassPath getWeatherActorPath()
    {
        return FSoftClassPath(TEXT("AActor'/AirSimV2/Weather/WeatherFX/WeatherActor.WeatherActor_C'"));
    }

    static const FSoftClassPath getWeatherMenuWidgetClass()
    {
        return FSoftClassPath(TEXT("UUserWidget'/AirSimV2/HUDAssets/OptionsMenu.OptionsMenu_C'"));
    }
