...
ACarPawn::ACarPawn()
{
    static ConstructorHelpers::FClassFinder<APIPCamera> pip_camera_class(TEXT("Blueprint'/AirSimV2/Blueprints/BP_PIPCamera'"));
    ...
    ConstructorHelpers::FObjectFinder<USoundCue> SoundCue(TEXT("/AirSimV2/VehicleAdv/Sound/Engine_Loop_Cue.Engine_Loop_Cue"));
