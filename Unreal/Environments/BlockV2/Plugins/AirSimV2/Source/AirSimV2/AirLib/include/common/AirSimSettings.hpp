    ...
    public: //types
        ...
        struct PawnPath
        {
            ...
            PawnPath(const std::string& pawn_bp_val = "",
                     const std::string& slippery_mat_val = "/AirSimV2/VehicleAdv/PhysicsMaterials/Slippery.Slippery",
                     const std::string& non_slippery_mat_val = "/AirSimV2/VehicleAdv/PhysicsMaterials/NonSlippery.NonSlippery")
    ...
    private:
        ...
        static void initializePawnPaths(std::map<std::string, PawnPath>& pawn_paths)
        {
            ...
            pawn_paths.emplace("BareboneCar",
                               PawnPath("Class'/AirSimV2/VehicleAdv/Vehicle/VehicleAdvPawn.VehicleAdvPawn_C'"));
            pawn_paths.emplace("DefaultCar",
                               PawnPath("Class'/AirSimV2/VehicleAdv/SUV/SuvCarPawn.SuvCarPawn_C'"));
            pawn_paths.emplace("DefaultQuadrotor",
                               PawnPath("Class'/AirSimV2/Blueprints/BP_FlyingPawn.BP_FlyingPawn_C'"));
            pawn_paths.emplace("DefaultComputerVision",
                               PawnPath("Class'/AirSimV2/Blueprints/BP_ComputerVisionPawn.BP_ComputerVisionPawn_C'"));
        }
